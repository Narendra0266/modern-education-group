...
const GALLERY_IMAGES = [
  {
    ...
    fallback: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?q=80&w=600&auto=format&fit=crop',
    alt: 'Modern Education Group Main Entrance',
  ...
  {
    type: 'video',
    src: 'https://assets.mixkit.co/videos/preview/mixkit-campus-of-a-large-university-from-a-drone-43282-large.mp4',
    fallback: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?q=80&w=600&auto=format&fit=crop',
    alt: 'Aerial campus flyover displaying lawns and main school halls',
    title: 'Aerial Campus Flyover',
    category: 'Infrastructure',
    aspect: 'aspect-[3/4]',
  },
  {
    ...
    fallback: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=600&auto=format&fit=crop',
    alt: 'Advanced High School Chemistry Experimentation',
    title: 'Molecular Science Wing',
    category: 'Academics',
    aspect: 'aspect-[3/4]',
  },
  {
    type: 'video',
    src: 'https://assets.mixkit.co/videos/preview/mixkit-focused-student-working-in-a-chemistry-lab-41617-large.mp4',
    fallback: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=600&auto=format&fit=crop',
    alt: 'Student conducting lab experiment inside chemical incubator hood',
    title: 'Biotech Lab Experiment',
    category: 'Academics',
    aspect: 'aspect-[3/2]',
  },
  {
    type: 'image',
    src: '/images/robotics_lab.png',
    fallback: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?q=80&w=600&auto=format&fit=crop',
    alt: 'Students assembling automated micro-controllers',
    title: 'Robotics Research Sandbox',
    category: 'STEM',
    aspect: 'aspect-[3/2]',
  },
  {
    type: 'video',
    src: 'https://assets.mixkit.co/videos/preview/mixkit-little-child-building-with-blocks-and-learning-robotics-43093-large.mp4',
    fallback: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?q=80&w=600&auto=format&fit=crop',
    alt: 'Early childhood STEM learning class assembling robotics components',
    title: 'Robotics Assembly Class',
    category: 'STEM',
    aspect: 'aspect-[4/3]',
  },
  {
    type: 'image',
    src: '/images/school_assembly.png',
    fallback: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?q=80&w=600&auto=format&fit=crop',
    alt: 'Modern Education Group school assembly gathering',
    title: 'Campus Assembly Ground',
    category: 'Campus Life',
    aspect: 'aspect-[4/3]',
  },
  {
    type: 'image',
    src: '/images/school_front.png',
    fallback: 'https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=600&auto=format&fit=crop',
    alt: 'Front entrance of the Modern Education Group main campus',
  ...
  },
  {
    ...
    fallback: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?q=80&w=600&auto=format&fit=crop',
    alt: 'Felicitation and message by our academic leadership board',
